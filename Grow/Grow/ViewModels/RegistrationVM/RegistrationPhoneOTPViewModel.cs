...
{
    class RegistrationPhoneOTPViewModel : ViewModelBase, IRegistrationPhoneOTPViewModel
    {
        ...
        public RegistrationPhoneOTPViewModel(IAuthenticationService InAuthenticationService, IUserService InUserService)
        {
        ...
        public async void VerifyOTPCode()
        {
            ...
            if (IsTimmerExipired())
            {
                ErrorPrompt = "Timer expired. Please return to the login page to send another otp.";
            ...
            if (LoginAttempt)
            {
                ...
                {
                    await Shell.Current.GoToAsync($"///{nameof(RegistrationPhoneExistsPage)}");
                }
                else
                {
                    Code = "";
